...
if (isset($_POST['s5'])) {
    $Csslc = $_POST['csslc'];
    $countResult = mysqli_query($connect, "SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND SSLC>='$Csslc'");
    $countData = mysqli_fetch_assoc($countResult);
    echo "<br><h3>Students Scored Above '$Csslc' in SSLC&nbsp:&nbsp";
    echo $countData['count(*)'];
    echo "</h3>";
    $sql = "SELECT * FROM basicdetails WHERE `Approve`='1' AND SSLC>='$Csslc'";
