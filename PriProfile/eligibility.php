...
$num_rec_per_page = 10; // Specify the number of records per page

$start_from = ($page - 1) * $num_rec_per_page;

$sql = "SELECT * FROM basicdetails WHERE Approve='1' ORDER BY column_name DESC LIMIT $start_from, $num_rec_per_page";

//$rs_result = $connect->query($sql);

// Rest of your code to fetch and display the records
