...
if (isset($_POST['s3'])) {
    $Csem = $_POST['csem'];
    $countResult = mysqli_query($connect, "SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND Sem='$Csem'");
    $countData = mysqli_fetch_assoc($countResult);
    echo "<br><h3>Students in Semester '$Csem'&nbsp:&nbsp";
    echo $countData['count(*)'];
    echo "</h3>";
    $sql = "SELECT * FROM basicdetails WHERE `Approve`='1' AND Sem='$Csem' ORDER BY Branch";
