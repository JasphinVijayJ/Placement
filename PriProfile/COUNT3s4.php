...
if (isset($_POST['s4'])) {
    ...
    $countResult = mysqli_query($connect, "SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND Branch='$Cbranch'");
    $countData = mysqli_fetch_assoc($countResult);
    echo "<br><h3>Students in '$Cbranch' Branch&nbsp:&nbsp";
    echo $countData['count(*)'];
    echo "</h3>";
    $sql = "SELECT * FROM basicdetails WHERE `Approve`='1' AND Branch='$Cbranch' ORDER BY Sem";
