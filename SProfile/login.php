      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
            <a href="Placement Drives.php" ><i class="fa fa-home fa-fw"></i>Placement Drives</a>
            </li>
            <li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <li>
                  <a href="../SProfile/Notif.php">Notifications</a>
                </li>
                <li>
                  <a href="../SProfile/Change Password.php">Change Password</a>
                  </li>
              </ul>
            </nav>
          </div>
