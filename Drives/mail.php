	...
	<div class="mail">
		...
		<div class="container">
			<div class="map footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<iframe src="https://goo.gl/maps/rEaQK1jmidPJvx3k7" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
			</div>
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>Agni College of Technology - ACT</h4>
					<p>OMR, Navallur, Thallambur, Chennai – 600 130,
						<span>Tamil Nadu, India</span></P>
					<p>Reception :044-67409441 to 044-67409499 
					<span>E-mail: <a href="mailto:mail@act.edu.in">mail@act.edu.in</a></span>
					</p>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Agni College of Technology - ACT</h6>
					<h4>
